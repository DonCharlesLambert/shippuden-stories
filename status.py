...
class StatusBar:
    ...
    def update_health(self):
        img = Image.open(os.path.join(PROJECT_NAME, 'sprites', 'misc', 'health bars', "100.png"))
    ...
    def get_mugshot(self):
        img = Image.open(os.path.join(PROJECT_NAME, 'sprites', self.fighter.name, "mug.png"))
    ...
    def get_outline(self):
        img = Image.open(os.path.join(PROJECT_NAME, 'sprites', 'misc', 'health bars', "outline.png"))
        img = self.scale_health_bar_img(img)
        health_bar = ImageTk.PhotoImage(img)
        return health_bar

    def get_chakra_bar(self):
        img = Image.open(os.path.join(PROJECT_NAME, 'sprites', 'misc', 'health bars', "100c.png"))
        img = self.scale_health_bar_img(img)
        health_bar = ImageTk.PhotoImage(img)
        return health_bar
